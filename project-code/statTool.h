...
public:
  ...
  expects, the region, a statGatherer and function pointers for the methods to fill in */
      ...
      // I implemented this because we needed a different format for worksheet
      ...
      static void computeStatsMixRegionData3(Visitor *theRegions, statGatherer *fillArrays,
