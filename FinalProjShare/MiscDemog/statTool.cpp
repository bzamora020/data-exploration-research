...
void statTool::computeStatsDemogRegionData(Visitor* theRegions, statGatherer* fillArrays,
    ...
    // cout << "SIZE OF VISITOR HASHMAPS, H then D : ";
    // theRegions->getHMsizes();
    ...
    cout << "Population Coeff: " <<stats::computeCorCoeff(dataXpercent, dataYpercent)<< endl;

}

// void statTool::computeStatsHospRegionData(Visitor* theRegions, statGatherer* fillArrays,
...
void statTool::computeStatsMixRegionData(Visitor* theRegions, statGatherer* fillArrays, 
    ...
    cout << "Correlation Coeff (sample): " <<stats::computeCorCoeff(dataX, dataY)<< endl;
