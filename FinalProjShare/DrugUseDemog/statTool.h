...
public:
  ...
  static void computeStatsDrugRegionData(Visitor* theRegions, statGatherer* fillArrays,
                                double (drugData::*f1)() const, double(drugData::*f2)() const,
                                int (drugData::*f3)() const, int (drugData::*f4)() const);
                                
  //compute for demog and hospital
  ...
  //compute for demog and drug
  static void computeStatsMixRegionData(Visitor* theRegions, statGatherer* fillArrays, 
        double (demogData::*f1)() const, double (drugData::*f2)() const);

  //compute for drug and hospital
  static void computeStatsMixRegionData(Visitor* theRegions, statGatherer* fillArrays, 
