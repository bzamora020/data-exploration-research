...
{
public:
    cityShootingData(string inState, string inCity, int inAge, string inRace, string inGender, string inMI, string inFleeing) : shootingData{inState, inAge, inRace, inGender, inMI, inFleeing}, hadMentalIllness(inMI)
    {
    }
