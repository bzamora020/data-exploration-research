...
public:
  ...
  static void computeStatsHospitalRegionData(Visitor* theRegions, statGatherer* fillArrays, 
        double (comboHospitalData::*f1)() const, double (comboHospitalData::*f2)() const);

      static void computeStatsDemogHouseRegionData(Visitor* theRegions, statGatherer* fillArrays, 
